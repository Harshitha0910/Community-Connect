...
const Footer = () => {        
    ...
    <div className="font-mono px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2025, All Rights Reserved by CommunityConnect</p>
    </div>
</section>
