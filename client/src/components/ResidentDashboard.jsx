            ...
            <div className="flex font-mono font-bold flex-1 bg-gray-50">
                        ...
                        <div className="flex flex-col flex-1 px-3 mt-6">
                            <div className="space-y-4">
                                <nav className="flex-1 space-y-2">
                                    ...
                                    <a href="/messages/private" className="flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 text-gray-900 hover:text-white rounded-lg hover:bg-zinc-900 group">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 mr-3">
                ...
                <div className="flex bg-gray-50 flex-col flex-1 relative">
                    ...
                    <div className="absolute top-4 right-4 z-50">
                        ...
                        {showDropdown && (
                            <div className="absolute right-0 mt-2 w-72 bg-white border rounded shadow-lg p-3">
                                ...
                                {notifications.length === 0 ? (
                                    ...
                                    <ul className="space-y-2 max-h-60 overflow-y-auto">
                                        {notifications.map((n, idx) => (
                                            <li
                                                key={idx}
                                                className="text-sm border-b pb-2 cursor-pointer hover:bg-gray-100 p-1 rounded"
                                            >
                                                {n.message}
                                            </li>
                                        ))}
